  ...
  function init() {
    ...
    demo.innerHTML = [
      '<div class="card" style="overflow:hidden;padding:0;margin:0">',
        ...
        '</div>',
        '<div style="display:grid;grid-template-columns:1fr 240px;min-height:420px">',
          '<div id="demo-scroller" style="padding:16px 20px;font-size:13px;line-height:1.6;overflow:auto;max-height:420px;border-right:1px solid var(--rule)"></div>',
